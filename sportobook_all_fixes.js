...
(function () {
  ...
  /* ════════════════════════════════════════════════════════════════
     0.  CSS — horizontal swipe row for #nearby-venues
     styles.css and older patches force display:grid or flex-column.
     Override everything here to enforce a single horizontal swipe row.
  ════════════════════════════════════════════════════════════════ */
  (function injectGridCSS() {
    var id = 'spb-grid-style';
    var existing = document.getElementById(id);
    if (existing) existing.remove(); /* always re-inject so we win */
    var s = document.createElement('style');
    s.id = id;
    s.textContent = [
      /* ── Swipe container — single horizontal row ── */
      '#nearby-venues {',
      '  display: flex !important;',
      ...
      /* ── Kill any width:100% on child cards so they stay narrow ── */
      '#nearby-venues > * {',
      ...
      '}',
      /* ── Exception: empty/loading states span full width ── */
