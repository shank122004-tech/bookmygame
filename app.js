...
async function processTournamentRegistration(tournamentId) {
    ...
    try {
        ...
        // In processTournamentRegistration, when calling showTournamentPayment
showTournamentPayment(tournamentData, registrationId, teamName);
// Make sure tournamentData has an id property
...
function showTournamentPayment(tournament, registrationId, teamName) {
    // Ensure tournament has id property
    ...
    if (payBtn) {
        ...
        newPayBtn.addEventListener('click', async () => {
            await initiateRazorpayPayment(tournamentData, registrationId, teamName);
        });
    }
